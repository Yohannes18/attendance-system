...
export default function RegisterForm() {
    ...
    useEffect(() => {
        ...
        if (uidParam) setUid(uidParam.toUpperCase());
    }, [searchParams]);
    ...
    return (
        <div className="max-w-md mx-auto px-6 py-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                <Field label="Card UID" hint="Auto-filled from scanned card">
                    <input
                        value={uid}
                ...
                {status === "success" && (
                    <p className="text-sm text-green-600 text-center">Student registered successfully! Redirecting…</p>
                )}
                {status === "error" && (
